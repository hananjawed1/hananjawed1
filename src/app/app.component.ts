...
export class AppComponent implements AfterViewInit {
  ...
  constructor(
    ...
    if (this.authenticationService.currentUserValue != null) {
      if (this.authenticationService.currentUserValue.role === 'Admin'
          ||
          this.authenticationService.currentUserValue.role === 'Employee'
          ||
          this.authenticationService.currentUserValue.role === 'Supervisor') {
      } else {
          this.logout();
      }
    }
  ...
  private init(): void {
    ...
    function closeSearch() {
      const $form = $('.main-header form[role="search"].active');
      $form.find('input').val('');
  ...
  private initDatatables(): void {
    ...
    $('#example1').length && $('#example1').DataTable({
      language: {
        searchPlaceholder: 'Search...',
        sSearch: '',
        lengthMenu: '_MENU_',
    ...
    // $('#example2').length && $('#example2').DataTable({
    //   // responsive: true,
    //   language: {
    //     searchPlaceholder: 'Search...',
    //     sSearch: '',
    ...
    $('#example-1').length && $('#example-1').DataTable({
      language: {
        searchPlaceholder: 'Search...',
        sSearch: '',
        lengthMenu: '_MENU_',
