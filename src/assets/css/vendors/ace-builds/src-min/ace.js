(function () {
  ...
  var r = typeof navigator == "object" ? navigator : {},
    i = (/mac|win|linux/i.exec(r.platform) || ["other"])[0].toLowerCase(), s = r.userAgent || "", o = r.appName || "";
  ...
  var r = e("../lib/event"), i = e("../lib/useragent"), s = e("../lib/dom"), o = e("../lib/lang"), u = i.isChrome < 18,
    a = i.isIE, f = i.isChrome > 63, l = 400, c = e("../lib/keys"), h = c.KEY_MODS, p = i.isIOS, d = p ? /\s/ : /\n/,
    v = function (e, t) {
      function W() {
    ...
    e.addEventListener("contextmenu", function (e) {
      ...
      if (b - o < 500 && f.length == 1 && !l) h++, e.preventDefault(), e.button = 0, g(); else {
        ...
        var E = t.selection.cursor, S = t.selection.isEmpty() ? E : t.selection.anchor,
          x = t.renderer.$cursorLayer.getPixelPosition(E, !0), T = t.renderer.$cursorLayer.getPixelPosition(S, !0),
    ...
    this.$defaultBehaviour = new o, this.tokenRe = new RegExp("^[" + u.wordChars + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + u.wordChars + "\\$_]|\\s])+", "g"), this.getTokenizer = function () {
      ...
      if (!this.lineCommentStart) {
        ...
        var c = this.blockComment.start, h = this.blockComment.end,
          p = new RegExp("^(\\s*)(?:" + a.escapeRegExp(c) + ")"), d = new RegExp("(?:" + a.escapeRegExp(h) + ")\\s*$"),
          v = function (e, t) {
            if (g(e, t)) return;
        ...
        var m = function (e, t) {
          ...
          if (!s || /\S/.test(e)) b(e, u, u) ? i.insertInLine({ row: t, column: u }, y) : i.insertInLine({
            row: t,
            column: u
          }, c)
        }, g = function (e, t) {
      ...
      if (!i) return;
      !i.start && i[0] && (i = i[0]);
      var s = new f(t, r.row, r.column), o = s.getCurrentToken(), u = t.selection, a = t.selection.toOrientedRange(), c,
        h;
  ...
  (function () {
    i.implement(this, o), this.setSession = function (e) {
      ...
      var s = e.element, o = this.session, u = s.childNodes[0], a = s.childNodes[1], f = o.$firstLineNumber,
        ...
        p = this.$showFoldWidgets && o.foldWidgets, d = n ? n.start.row : Number.MAX_VALUE, v = "ace_gutter-cell ";
